...
public interface RequestRepository extends JpaRepository<Request, Integer> {
	...
	public List<Request> findByStudentIdstudenti(int studentID);

	public Request findByIdcereri(int requestID);

	public List<Request> findByStudentIdstudentiAndTeacherIdprofesori(int studentID, int teacherID);

	@Transactional
	@Modifying
	@Query("update studenti s set s.cv = :file where s.user.userID = :userID")
	public void setCV(@Param("file") byte[] file, @Param("userID") int userID);
	...
	public void updateRequestStatus(@Param("status") String status, @Param("studentID") int studentID,
	...
	public void updateRequestStatusWithProject(@Param("status") String status, @Param("studentID") int studentID,
			@Param("teacherID") int teacherID, @Param("idTema") int idTema);
	...
	public List<Request> findByStudentIdstudentiAndTeacherIdprofesoriAndTemaNume(int studentID, int teacherID,
			String projectName);
